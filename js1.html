<html>
    <head>
        ...
        <script>
            function hello()
            {
                alert ("selamat anda mendapatkan hadiah 1 unit ZX!");
    ...
    <body>
        <div class="container">
            <button class="btn btn-primary" onclick="hello();">Klik disini untuk melanjutkan</button>
<p> <!-- id untuk operasi menggunakan coding -->
    Bilangan 1 :
